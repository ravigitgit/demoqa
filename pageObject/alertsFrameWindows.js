...
export class AlertsFrameWindows {
    constructor(page) {
        this.page = page;
        this.locators = new Locators(page);
    }

    async navigateToHeader(groupHeader, header) {
        await this.page.goto('/');
        await this.locators.page.getByText(groupHeader, { exact: true }).scrollIntoViewIfNeeded();
        await this.locators.page.getByText(groupHeader, { exact: true }).click();

        await this.locators.page.getByText(header, { exact: true }).scrollIntoViewIfNeeded();
        await this.locators.page.getByText(header, { exact: true }).click();
    }
